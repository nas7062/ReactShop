...
import '../LazyTest/LazyTest.css'
// lazy를 사용하여 컴포넌트 동적 로딩
const LazyComponent = lazy(() => import('../LazyTest/LazyComponent'))
const LazyDashboard = lazy(() => import('../LazyTest/DashBoard'))
const LazyAnalytics = lazy(() => import('../LazyTest/Analytics'))
